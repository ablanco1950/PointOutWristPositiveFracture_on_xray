...
######################################################################
dir=""
dirname= "train\\images\\"
dirnameLabels="train\\labels\\"
Outputdirname= "trainFractureWristPositive\\images"
OutputdirnameLabels="trainFractureWristPositive\\labels"
import os

import shutil
output_dir="trainFractureWristPositive"
...
print("Number of records to train Wrist Positive = " + str(ContWristPositiv))
