...
######################################################################
dir=""
dirname= "valid\\images\\"
dirnameLabels="valid\\labels\\"
Outputdirname= "validFractureWristPositive\\images"
OutputdirnameLabels="validFractureWristPositive\\labels"
import os

import shutil
output_dir="validFractureWristPositive"
...
print("Number of records to valid Wrist Positive = " + str(ContWristPositiv))
